...
emotions_data = {
    ...
    "비루함": {
         "keywords": ["슬픔", "비하", "습관", "더러움", "더럽", "추함", "추하", "비루", "슬프", "슬퍼"], 
    ...
    "자긍심": {
        "keywords":["고찰", "기쁨", "긍지", "보람", "자부심", "자금심", "뿌듯", "기뻐", "기쁘"], 
    ...
    "경탄": { 
        "keywords": ["놀람", "무지", "일시", "감탄", "신기", "놀라", "깜짝", "헉", "놀람"], 
    ...
    "경쟁심": { 
        "keywords": ["적대", "질투", "수동", "비교", "욕망", "욕구", "경쟁", "견제", "질투", "의식"],  
    ...
    "야심": { 
        "keywords": ["욕망", "욕구", "소망", "질투", "경쟁심", "명예", "야심", "야망", "목표", "꿈"], 
    ...
    "사랑": { 
        "keywords": ["기쁨", "정성", "애정", "귀중", "소중", "즐겁", "즐거", "아낌", "사랑"], 
    ...
    "대담함": { 
        "keywords": ["기쁨", "기쁘", "용기", "극복", "자신", "자율", "대담", "위험", "노력"], 
    ...
    "대담함": {
        "keywords": ["기쁨", "기쁘", "용기", "극복", "자신", "자율", "대담", "강심장"],  
    ...
    "회한": {
        "keywords": ["슬픔", "한탄", "깨달음", "뉘우침", "고통", "후회", "회한"],
    ...
    "분노": {
        ...
        "solution": "이성을 통해 분노를 조절하는 능력을 길러야 합니다. 하지만, 분노는 구성원들 간의 연대를 이끌기 때문에 사라져야 하는 불필요한 감정은 아닙니다. 따라서, 중용을 지키는 것이 중요합니다." 
    }, 
    ...
    "동정": {
        "keywords": ["동일시", "사랑", "기쁨", "기뻐", "타인", "선의", "불쌍"], 
